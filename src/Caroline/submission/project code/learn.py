...
predicted_scores = preprocessing.MinMaxScaler(feature_range=(-10, 2)).fit_transform(predicted_scores)
...
for i in range(len(predicted_scores)):
	predicted_scores[i] = abs(predicted_scores[i] - mean)
'''
plt.subplot(3,1,3)
plt.scatter(predicted_scores, orig_scores)
plt.show()
...
moneys = []
barriers = [i/1000 for i in range(1,2100,1)]
